...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	*CONVERT CSV TO DTA	
		/* EXAMPLE:
		clear 
		insheet using "FILE PATHWAY FOR YOUR ANTIMALARIAL LIST USED ALONG SIDE THE QUESTIONNAIRE"
		*/ 
		
		clear
		insheet using "${projdir}/07 Product masterlists/ANTIMALARIALMASTERLIST.csv"
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	*CONVERT CSV TO DTA
		/* EXAMPLE:
		clear 
		insheet using "FILE PATHWAY FOR YOUR RDT LIST USED ALONG SIDE THE QUESTIONNAIRE"
		*/ 
		
		clear 
		insheet using "${projdir}/07 Product masterlists/RDTMASTERLIST.csv"
	...
	*CLEAN
		...
		strtu // ### converts all string variable contents to uppercase
		rename product_id rdtcode //  ### renames identification ID variable in the antimalarial dataset to amcode
