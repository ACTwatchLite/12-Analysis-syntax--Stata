...
*(should be variables value = 1 if case located in that stratum or otherwise =. (missing), named for each stratum) in the line below the ds below
	...
	gen strat1=1 if strata==11
	gen strat2=1 if strata==22
	gen strat3=1 if strata==33
...
*EXAMPLE: 
	ds ///
mas_code reg_code unexpired_pack
...
sa5_1 sa5_2 sa5_3 sa5_4 sa5_96 /// supplier payment means
