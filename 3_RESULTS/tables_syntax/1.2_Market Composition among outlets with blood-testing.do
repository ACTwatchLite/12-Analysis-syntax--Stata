...
*table label
	...
	*labels	
	...
	putexcel C1= ("Footnote: Rural outlets that met screening criteria for a full interview but did not complete the interview with any diagnostics in stock = `footnote1' ")
	putexcel C1= ("Urban outlets that met screening criteria for a full interview but did not complete the interview with any diagnostics in stock = `footnote2' ")
...
local tabname T_iv_`s'	
	...
	*labels	
	...
	putexcel D1= ("Urban outlets that met screening criteria for a full interview but did not complete the interview with any diagnostics in stock = `footnote2'")
