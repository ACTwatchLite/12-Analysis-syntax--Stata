...
********************************************************************************
	...
	*labels	
	...
	putexcel C1= ("Footnote - N Rural screened outlets: Private not for profit=`footnote1'; private not for profit=`footnote2'; pharmacy=`footnote3'; PPMV=`footnote4'; informal=`footnote5'; labs = `footnote6'; wholesalers= `footnote7'. Rural outlets that met screening criteria for a full interview but did not complete the interview (were not interviewed or completed a partial interview) = `footnote8' ")
	putexcel D1= ("N Urban screened outlets: Private not for profit=`footnote9'; private not for profit=`footnote10'; pharmacy=`footnote11'; PPMV=`footnote12'; informal=`footnote13'; labs = `footnote14'; wholesalers= `footnote15'. Urban outlets that met screening criteria for a full interview but did not complete the interview (were not interviewed or completed a partial interview) = `footnote16' ")
	...
	*labels	
	...
	putexcel A3=("variable name")
		...
		*footnotes into excel file:
		putexcel C1= ("`s' Footnote - N rural screened outlets: Private not for profit=`footnote1'; private not for profit=`footnote2'; pharmacy=`footnote3'; PPMV=`footnote4'; informal=`footnote5'; labs = `footnote6'; wholesalers= `footnote7'. Rural utlets that met screening criteria for a full interview but did not complete the interview (were not interviewed or completed a partial interview) = `footnote8' ")
		putexcel D1= ("N urban screened outlets: Private not for profit=`footnote9'; private not for profit=`footnote10'; pharmacy=`footnote11'; PPMV=`footnote12'; informal=`footnote13'; labs = `footnote14'; wholesalers= `footnote15'. Urban outlets that met screening criteria for a full interview but did not complete the interview (were not interviewed or completed a partial interview) = `footnote16' ")
