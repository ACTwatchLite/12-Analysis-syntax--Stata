...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	*prepare RDT suppliers for append
		* import data from primary .csv file
			clear 
			/* EXAMPLE:
			insheet using "${datadir}/raw/AwL-${country}-${year}-supplier.csv", names clear
			*/
		...
		* save data from primary .dta file					
		save "${datadir}/raw/AwL_${country}_${year}-suppliers.dta", replace		
		
*NOTE STEP 1.4.1.2 HAS BEEN REMOVED BECAUSE SUPPLIERS FOR RDTS AND ANTIMALARIALS ARE CAPTURED TOGETHER IN THE TOOLKIT VERION OF THE QUNATITATIVE ODK FORM. 
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	*define type from form
	/* EXAMPLE: 
	cap label define supptype ///
	...
	*define the supp4 (supplier location) var labels:	
	/* EXAMPLE: 
	cap label variable supp4 "Supplier location- state"
		label define supploc 1 "STATE 1" 2 "STATE 2" 3 "STATE 3" ///
			96 "Other" -9998 "Don't know" -9777 "Refused"
		label values supp4 supploc
		
		*/

	cap label variable supp5 "Supplier location - City / town"
	cap label variable supp6 "Supplier address"
	cap label variable supp7 "Supplier contact"
	cap label variable source "supplier type/ source dataset"	
	
	cap label define source ///
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	merge m:1 key using ///
	"${datadir}/1_CLEANING/AwL_${country}_${year}-outlet_prepared.dta", ///
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	save "${datadir}/1_CLEANING/AwL_${country}_${year}-suppliers_prepared.dta", replace
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
save "${datadir}/1_CLEANING/AwL_${country}_${year}-suppliers_clean.dta", replace
...
*clear				
*use "${datadir}/1_CLEANING/AwL_${country}_${year}-suppliers_clean.dta", replace
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
export excel using "${analydir}/lists/supplier-list.xlsx", firstrow(variables)  replace
