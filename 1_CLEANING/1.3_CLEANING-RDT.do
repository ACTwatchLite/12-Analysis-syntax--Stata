...
* import data from primary .csv file for RDT audits
	/* EXAMPLE:
	insheet using "${datadir}/raw/AwL-${country}-${year}-rdtAudit.csv", names clear
	*/
...
*run .do file for variable labels for this dataset. 
	do "${analydir}/1_CLEANING/variable-lables/varlbl_syntax_rdtaudit.do"
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
	...
	merge m:1 key using ///
		...
		keepusing (formtype outletid consented s5b s6 rdt_stock d7 status setofrdtaudit rdtaudit_complet)
...
*SAVE PREPARED DATA
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
save "${datadir}/1_CLEANING/AwL_${country}_${year}-rdtaudit_prepared.dta", replace
...
*COUNTRY OF MANUFACTURER - OTHER SPECIFY
  /*Recode other-specify country of manufacturer responses to valid types. Use
	...
	tab rdtCountry_other if rdtCountry == 996 | rdtCountry == 998
	/*
...
**$$$ recode all other countries 
	/* EXAMPLE:
	recode rdtCountry (996=1) if regexm(rdtCountry_other,"SHANDON") | regexm(rdtCountry_other,"SHANGDONG") // China
	replace rdtCountry=10 if rdtCountry_other=="REPUBLIC OF KOREA"
	lab def rdtCountry_other 901 "MALAYSIA", add 
 	recode rdtCountry (996=901) if rdtCountry_other=="MALAYSIA"
*/
...
* MERGE QA RDT database with the RDT datasets
			...
			tostring rdtcode, replace
			
			
			merge m:1 rdtcode using ///
			"${analydir}/lists/rdt_masterlist.dta", ///
...
*SAVE CLEAN DATASET
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
save "${datadir}/1_CLEANING/AwL_${country}_${year}-rdtaudit_clean.dta", replace	
